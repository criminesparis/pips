/*
  ...
  $Id: hash.c 1377 2018-03-26 12:07:32Z coelho $
...
static int hash_int_equal(const void*, const void*); // was int, then _int...
...
static int hash_int_equal(const void *key1, const void * key2)
{
  return ((_int) key1) == ((_int) key2);
}
