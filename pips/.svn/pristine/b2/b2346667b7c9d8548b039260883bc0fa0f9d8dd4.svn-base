...
DBR_LIVE_OUT_REGIONS: 	STATEMENT_FUNCTION_METHODS
...
# Task generation
DBR_TASK: 	STATEMENT_FUNCTION_METHODS
# DBR_TASK: 	NEWGEN_METHODS
...
# MODELING
DBR_TASK_VARIABLE_CHANGED_BY: NEWGEN_METHODS
