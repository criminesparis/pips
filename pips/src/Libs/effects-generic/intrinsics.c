/*
  ...
  $Id: intrinsics.c 23466 2018-03-12 03:08:18Z ancourt $
...
// for add_index_range_conditions() & other stuff
// ??? should be in effects-convex?!
...
static list actual_pointer_argument_to_cells(expression);
//static list cells_to_write_effects(list);

// Use directly by IntrinsicDescriptor
static list not_implemented_intrinsics_effects(entity, list );
static list time_effects(entity, list );
static list time_buffer_effects(entity, list );
...
static list memcpy_effects(entity e,list args);
...
static list end_program_effects(entity e, list args);
static list end_process_effects(entity e, list args);

// Use indirectly by IntrinsicDescriptor
static list any_rgs_effects(entity e, list args, bool write_p, bool read_p);
static list generic_logical_units_effects(expression unit, bool only_read_p);
static list generic_c_io_effects(entity e,list args, bool system_p);
static list effects_of_C_ioelem(expression exp, tag act);
static list effects_of_any_ioelem(expression exp, tag act, bool is_fortran); //only for FORTRAN in fact
static list effects_of_ioelem(expression exp, tag act);
static list effects_of_iolist(list exprs, tag act);
// NL: This last function is directly use by intrinsic???
//     {IMPLIED_DO_NAME,                        effects_of_implied_do},
//     I thank that the first arg must be entity and second a list???
static list effects_of_implied_do(expression exp, tag act);

// MPI Functions
static list mpi_functions_effects(entity e, list args);
static list mpi_send_effects(entity e, list args);
...
static IntrinsicDescriptor IntrinsicEffectsDescriptorTable[] = {
  ...
  {ENDDO_FUNCTION_NAME,                    no_write_effects},
  ...
  {PIPS_C_MAX_OPERATOR_NAME,               no_write_effects},
  ...
  {PIPS_C_DIV_OPERATOR_NAME,               no_write_effects},
 ...
 /* ISO 6.5.11 bitwise exclusive OR operator */
  ...
  {C_RETURN_FUNCTION_NAME,                 end_program_effects},
  ...
  {ABORT_FUNCTION_NAME,                    end_process_effects},
  {ATEXIT_FUNCTION_NAME,                   end_process_effects},
  {EXIT_FUNCTION_NAME,                     end_process_effects},
  // In unistd.h
  //{_EXIT_FUNCTION_NAME,                    end_process_effects},
  ...
  {MEMCPY_FUNCTION_NAME,                   memcpy_effects},
  {MEMMOVE_FUNCTION_NAME,                  memcpy_effects},
  ...
  {STRCMP_FUNCTION_NAME,                   memcpy_effects},
  {STRCOLL_FUNCTION_NAME,                  no_write_effects},
  {STRNCMP_FUNCTION_NAME,                  memcpy_effects},
  ...
  /* The effets are wrong or at least incomplete, for most of these
  ...
  // modify its argument...
  {MKTIME_FUNCTION_NAME,                   not_implemented_intrinsics_effects},
  // Side effect
  {STRFTIME_FUNCTION_NAME,                 no_write_effects},
  // Side effect
  {STRPTIME_FUNCTION_NAME,                 no_write_effects}, 
  // Side effect
  {STRFTIME_L_FUNCTION_NAME,               no_write_effects}, 
  // Side effect
  {STRPTIME_L_FUNCTION_NAME,               no_write_effects}, 
  // Conversion function, not thread-safe, writes a static buffer
  {GMTIME_FUNCTION_NAME,                   time_buffer_effects},
  // Conversion function, not thread-safe, writes a static buffer
  {LOCALTIME_FUNCTION_NAME,                time_buffer_effects},
  // Thread-safe
  {GMTIME_R_FUNCTION_NAME,                 no_write_effects},
  // Thread-safe
  {LOCALTIME_R_FUNCTION_NAME,              no_write_effects},
  // Side effect
  {ASCTIME_FUNCTION_NAME,                  time_buffer_effects},
  // Side effect
  {CTIME_FUNCTION_NAME,                    no_write_effects},
  // Side effect
  {ASCTIME_R_FUNCTION_NAME,                no_write_effects},
  // Side effect
  {CTIME_R_FUNCTION_NAME,                  no_write_effects},
  // Side effect
  {TZSET_FUNCTION_NAME,                    no_write_effects},
  // Side effect
  {STIME_FUNCTION_NAME,                    no_write_effects},
  {TIMEGM_FUNCTION_NAME,                   no_write_effects},
  {TIMELOCAL_FUNCTION_NAME,                no_write_effects},
  {DYSIZE_FUNCTION_NAME,                   no_write_effects},
  {NANOSLEEP_FUNCTION_NAME,                no_write_effects},
  {CLOCK_GETRES_FUNCTION_NAME,             no_write_effects},
  {CLOCK_GETTIME_FUNCTION_NAME,            time_effects},
  {CLOCK_SETTIME_FUNCTION_NAME,            no_write_effects},
  {CLOCK_NANOSLEEP_FUNCTION_NAME,          no_write_effects},
  {CLOCK_GETCPULOCKID_FUNCTION_NAME,       no_write_effects},
  {TIMER_CREATE_FUNCTION_NAME,             no_write_effects},
  {TIMER_DELETE_FUNCTION_NAME,             no_write_effects},
  {TIMER_SETTIME_FUNCTION_NAME,            no_write_effects},
  {TIMER_GETTIME_FUNCTION_NAME,            no_write_effects},
  {TIMER_GETOVERRUN_FUNCTION_NAME,         no_write_effects},
  {GETDATE_FUNCTION_NAME,                  no_write_effects},
  {GETDATE_R_FUNCTION_NAME,                no_write_effects},
  ...
  /* C IO system functions in man -S 2, unless they also are in unistd.h */
  ...
  /* unistd.h, in the header file order */

  {LSEEK_FUNCTION_NAME,                    unix_io_effects},
  {LSEEK64_FUNCTION_NAME,                  unix_io_effects},
  {C_CLOSE_FUNCTION_NAME,                  unix_io_effects},
  {C_READ_FUNCTION_NAME,                   unix_io_effects},
  {C_WRITE_FUNCTION_NAME,                  unix_io_effects},
  {PREAD_FUNCTION_NAME,                    unix_io_effects},
  {PWRITE_FUNCTION_NAME,                   unix_io_effects}, 
  {PREAD64_FUNCTION_NAME,                  unix_io_effects},
  {PIPE_FUNCTION_NAME,                     no_write_effects},
  {PIPE2_FUNCTION_NAME,                    no_write_effects},
  {SLEEP_FUNCTION_NAME,                    no_write_effects},
  {UALARM_FUNCTION_NAME,                   no_write_effects},
  {USLEEP_FUNCTION_NAME,                   no_write_effects},
  {C_PAUSE_FUNCTION_NAME,                  no_write_effects},
  {CHOWN_FUNCTION_NAME,                    no_write_effects},
  {FCHOWN_FUNCTION_NAME,                   no_write_effects},
  {LCHOWN_FUNCTION_NAME,                   no_write_effects},
  {FCHOWNAT_FUNCTION_NAME,                 no_write_effects},
  {CHDIR_FUNCTION_NAME,                    no_write_effects},
  {FCHDIR_FUNCTION_NAME,                   no_write_effects},
  {GETCWD_FUNCTION_NAME,    		                                 no_write_effects},
  {GET_CURRENT_DIR_NAME_FUNCTION_NAME,               no_write_effects},
  {GETWD_FUNCTION_NAME,                    no_write_effects},
  {DUP_FUNCTION_NAME,                      no_write_effects},
  {DUP2_FUNCTION_NAME,                     no_write_effects},
  {DUP3_FUNCTION_NAME,                     no_write_effects},
  {EXECVE_FUNCTION_NAME,                   no_write_effects},
  {FEXECVE_FUNCTION_NAME,                  no_write_effects},
  {EXECV_FUNCTION_NAME,                    no_write_effects},
  {EXECLE_FUNCTION_NAME,                   no_write_effects},
  {EXECL_FUNCTION_NAME,                    no_write_effects},
  {EXECVP_FUNCTION_NAME,                   no_write_effects},
  {EXECLP_FUNCTION_NAME,                   no_write_effects},
  {EXECVPE_FUNCTION_NAME,                  no_write_effects},
  {NICE_FUNCTION_NAME,                     no_write_effects},
  {_EXIT_FUNCTION_NAME,                    end_process_effects},
  {PATHCONF_FUNCTION_NAME,                 no_write_effects},
  {FPATHCONF_FUNCTION_NAME,                no_write_effects},
  {SYSCONF_FUNCTION_NAME,                  no_write_effects},
  {CONFSTR_FUNCTION_NAME,                  no_write_effects},
  {GETPID_FUNCTION_NAME,                   no_write_effects},
  {GETPPID_FUNCTION_NAME,                  no_write_effects},
  {GETPGRP_FUNCTION_NAME,                  no_write_effects},
  {__GETPGID_FUNCTION_NAME,                no_write_effects},
  {GETPGID_FUNCTION_NAME,                  no_write_effects},
  {SETPGID_FUNCTION_NAME,                  no_write_effects},
  {SETPGRP_FUNCTION_NAME,                  no_write_effects},
  {SETSID_FUNCTION_NAME,                   no_write_effects},
  {GETSID_FUNCTION_NAME,                   no_write_effects},
  {GETUID_FUNCTION_NAME,                   no_write_effects},
  {GETEUID_FUNCTION_NAME,                  no_write_effects},
  {GETGID_FUNCTION_NAME,                   no_write_effects},
  {GETEGID_FUNCTION_NAME,                  no_write_effects},
  {GETPGROUPS_FUNCTION_NAME,               no_write_effects},
  {GROUP_MEMBER_FUNCTION_NAME,             no_write_effects},
  {SETUID_FUNCTION_NAME,                   no_write_effects},
  {SETREUID_FUNCTION_NAME,                 no_write_effects},
  {SETEUID_FUNCTION_NAME,                  no_write_effects},
  {SETGID_FUNCTION_NAME,                   no_write_effects},
  {SETREGID_FUNCTION_NAME,                 no_write_effects},
  {SETEGID_FUNCTION_NAME,                  no_write_effects},
  {GETRESUID_FUNCTION_NAME,                no_write_effects},
  {GETRESGID_FUNCTION_NAME,                no_write_effects},
  {SETRESUID_FUNCTION_NAME,                no_write_effects},
  {SETRESGID_FUNCTION_NAME,                no_write_effects},
  {FORK_FUNCTION_NAME,                     no_write_effects},
  {VFORK_FUNCTION_NAME,                    no_write_effects},
  {TTYNAME_FUNCTION_NAME,                  no_write_effects},
  {TTYNAME_R_FUNCTION_NAME,                no_write_effects},
  {ISATTY_FUNCTION_NAME,                   no_write_effects},
  {TTYSLOT_FUNCTION_NAME,                  no_write_effects},
  {LINK_FUNCTION_NAME,                     c_io_effects},
  {LINKAT_FUNCTION_NAME,                   no_write_effects},
  {SYMLINK_FUNCTION_NAME,                  c_io_effects},
  {READLINK_FUNCTION_NAME,                 c_io_effects},
  {SYMLINKAT_FUNCTION_NAME,                no_write_effects},
  {READLINKAT_FUNCTION_NAME,               no_write_effects},
  {UNLINK_FUNCTION_NAME,                   c_io_effects},
  {UNLINKAT_FUNCTION_NAME,                 c_io_effects},
  {RMDIR_FUNCTION_NAME,                    no_write_effects},
  {TCGETPGRP_FUNCTION_NAME,                no_write_effects},
  {TCSETPGRP_FUNCTION_NAME,                no_write_effects},
  {GETLOGIN_FUNCTION_NAME,                 no_write_effects},
  {GETLOGIN_R_FUNCTION_NAME,               no_write_effects},
  {SETLOGIN_FUNCTION_NAME,                 no_write_effects},
  {GETHOSTNAME_FUNCTION_NAME,              no_write_effects},
  {SETHOSTNAME_FUNCTION_NAME,              no_write_effects},
  {SETHOSTID_FUNCTION_NAME,                no_write_effects},
  {GETDOMAINNAME_FUNCTION_NAME,            no_write_effects},
  {SETDOMAINNAME_FUNCTION_NAME,            no_write_effects},
  {VHANGUP_FUNCTION_NAME,                  no_write_effects},
  {REVOKE_FUNCTION_NAME,                   no_write_effects},
  {PROFIL_FUNCTION_NAME,                   no_write_effects},
  {ACCT_FUNCTION_NAME,                     no_write_effects},
  {GETUSERSHELL_FUNCTION_NAME,             no_write_effects},
  {ENDUSERSHELL_FUNCTION_NAME,             no_write_effects},
  {SETUSERSHELL_FUNCTION_NAME,             no_write_effects},
  {DAEMON_FUNCTION_NAME,                   no_write_effects},
  {CHROOT_FUNCTION_NAME,                   no_write_effects},
  {GETPASS_FUNCTION_NAME,                  no_write_effects},
  {FSYNC_FUNCTION_NAME,                    unix_io_effects},
  {SYNCFS_FUNCTION_NAME,                   no_write_effects},
  {GETHOSTID_FUNCTION_NAME,                no_write_effects},
   {GETPAGESIZE_FUNCTION_NAME,             no_write_effects},
   {GETDTABLESIZE_FUNCTION_NAME,           no_write_effects},
  {TRUNCATE_FUNCTION_NAME,                 no_write_effects},
  {TRUNCATE64_FUNCTION_NAME,               no_write_effects},
  {FTRUNCATE_FUNCTION_NAME,                no_write_effects},
   {FTRUNCATE64_FUNCTION_NAME,             no_write_effects},
  {BRK_FUNCTION_NAME,                      no_write_effects},
  {SBRK_FUNCTION_NAME,                     no_write_effects},
  {SYSCALL_FUNCTION_NAME,                  no_write_effects},
  {LOCKF_FUNCTION_NAME,                    no_write_effects},
  {LOCKF64_FUNCTION_NAME,                  no_write_effects},
  {FDATASYNC_FUNCTION_NAME,                unix_io_effects},
  {CRYPT_FUNCTION_NAME,                    no_write_effects},
  {ENCRYPT_FUNCTION_NAME,                  no_write_effects},
  {SWAB_FUNCTION_NAME,                     no_write_effects},
  // Also found in stdio.h
  // {CTERMID_FUNCTION_NAME,                  no_write_effects},
  ...
  /* MPI intrinsics */
  {MPI_INIT_FUNCTION_NAME,              mpi_functions_effects},
  {MPI_FINALIZE_FUNCTION_NAME,          mpi_functions_effects},
  {MPI_BARRIER_FUNCTION_NAME,           mpi_functions_effects},
//TODO Check effet
  {MPI_COMM_SIZE_FUNCTION_NAME,         mpi_functions_effects},
  {MPI_COMM_RANK_FUNCTION_NAME,         mpi_functions_effects},
  {MPI_SEND_FUNCTION_NAME,              mpi_send_effects},
  {MPI_SSEND_FUNCTION_NAME,             mpi_functions_effects},
  {MPI_RSEND_FUNCTION_NAME,             mpi_functions_effects},
  {MPI_BSEND_FUNCTION_NAME,             mpi_functions_effects},
  {MPI_ISEND_FUNCTION_NAME,             mpi_functions_effects},
  {MPI_ISSEND_FUNCTION_NAME,            mpi_functions_effects},
  {MPI_IRSEND_FUNCTION_NAME,            mpi_functions_effects},
  {MPI_IBSEND_FUNCTION_NAME,            mpi_functions_effects},
  {MPI_RECV_FUNCTION_NAME,              mpi_functions_effects},
  {MPI_IRECV_FUNCTION_NAME,             mpi_functions_effects},
  {MPI_SENDRECV_FUNCTION_NAME,          mpi_functions_effects},
...
/**
 * In Fortran, write on parameters can be observed by the caller,
 * hence the historical name of this function. Not in C, where
 * parameter are passed by value. However dereferencings and side
 * effects are much more common in C. In case a pointer is passed, it
 * is not possible, in general, to guess if it is dereference or
 * not. However, pointers passed to intrinsics are passed to be
 * dereferenced. Unfortunately, this function is called recursively
 * and the above rule does not apply in general. Specific functions
 * are needed to handle intrinics precisely.
 *
 * NL: the name of the function is certainly badly chosen
 *     because it also compute side effects, which induce write effects.
 *
 * FI: beware when pointers are passed, directly or indirectly, via an
 *     array containing pointers or structs, or a struct containing
 *     pointers or arrays, and when they are dereferenced. However,
 *     intrinsics are unlikely to have struct as argument because they
 *     are inefficiently passed by value. Arrays of structs or
 *     pointers are unlikely too.
 */
static list
no_write_effects(entity e __attribute__ ((__unused__)), list args)
{
	...
	if(pointer_type_p(at)) {
	  // Look for the sinks
	  list cl = actual_pointer_argument_to_cells(a);
	  list el = cells_to_read_effects(cl);
	  lr = gen_nconc(lr, el);
	}
	else if(array_type_p(at)) {
	  // pips_internal_error("No array that is not used as pointer expected as intrinsic argument.\n");
	  list cl = actual_pointer_argument_to_cells(a);
	  list el = cells_to_read_effects(cl);
	  lr = gen_nconc(lr, el);
	}
	else if(struct_type_p(at)) {
	  pips_internal_error("No struct expected as intrinsic argument.\n");
	}
	else {
	  ; // ignore
	}
...
search_io_element(const char *s, const char *i)
{
...
static IoElementDescriptor*
search_c_io_Element(const char *s)
{
   IoElementDescriptor *p = IoElementDescriptorTable;
...
//  // To know if LUNS are used in code, so if they have to appear on return statement
//  /**
//   * NL: to be more precise (EXACT READ for return), we can keep a list of all the LUNS used
//   */
//  static bool use_luns_p = false;
//  if (only_read_p && !use_luns_p) {
//    return le;
//  }
//  use_luns_p = true;

  list indices = CONS(EXPRESSION, unit, NIL);
  entity private_io_entity =
      FindEntity(IO_EFFECTS_PACKAGE_NAME, IO_EFFECTS_ARRAY_NAME);
  pips_assert("private_io_entity is defined",
      !entity_undefined_p(private_io_entity));

  reference ref1 = make_reference(private_io_entity, indices);

  /**
   * NL: If it's not unbounded and not a number, unit expression must have some READ (and WRITE?)
   */
  // Add Read Effects/Regions
  if(!unbounded_expression_p(unit) && !expression_integer_constant_p(unit)) {
    le = gen_nconc(le, generic_proper_effects_of_read_reference(ref1));
    // NL: it's was done after the if
    //if (!only_read_p) {
    //  reference ref2 = copy_reference(ref1);
    //  /**
    //   * NL: we can have a duplication of a READ on unit
    //   *     but (*reference_to_effect_func) doestn't keep polyhedral constraint
    //   *     and we will have to add it manually
    //   *     so decide to use generic_proper_effects_of_write_reference
    //   *       even if it implicate duplication of READ on unit
    //   */
    //  le = gen_nconc(le, generic_proper_effects_of_written_reference(ref2));
    //}
  }
  else {
    ...
    effect eff1 = (*reference_to_effect_func)(ref1, make_action_read_memory(), true);
  ...
  if (!only_read_p) {
    ...
    // reference_to_convex_region
    // reference_to_reference_effect
    effect eff2 = (*reference_to_effect_func)(ref2, make_action_write_memory(), true);
    if(unbounded_expression_p(unit)) {
      effect_to_may_effect(eff2);
    }
    le = gen_nconc(le, CONS(EFFECT, eff2, NIL));
  }

  // Add Read Environment for LUNS
  if (!get_bool_property("MEMORY_EFFECTS_ONLY")) {
    //reference refe = make_reference(private_io_entity, NIL);
    // functions that can be pointed by reference_to_effect_func:
    // reference_to_simple_effect
    // reference_to_convex_region
    // reference_to_reference_effect
    //effect effe = (*reference_to_effect_func)(refe, make_action_read(make_action_kind_environment()), true);
    effect effe = make_declaration_effect(private_io_entity, false);
    le = gen_nconc(CONS(EFFECT, effe, NIL), le);
  }

  // Add context constraint if available
  // come from generic_proper_effects_of_reference
  if (effects_private_current_context_stack_initialized_p()
    ...
    // NL: In some case context can be undefined (I don't know how?)
  ...
  ifdebug(8) {
    pips_assert("IO Effects should be OK...",
...
make_io_read_write_memory_effects(entity e __attribute__ ((__unused__)), list args __attribute__ ((__unused__)))
{
    ...
    list le = NIL;
    expression unit = int_to_expression(STDERR_LUN);

    le = gen_nconc(le, generic_logical_units_effects(unit, false));
...
static list io_effects(entity e, list args)
{
    ...
    for (pc = args; pc != NIL; pc = CDR(pc)) {
        ...
        p = search_io_element(entity_local_name(e), entity_local_name(ci));
...
/* generic_c_io_effects() to encompass the system functions and the C
...
static list generic_c_io_effects(entity e, list args, bool system_p)
{
  ...
  p = search_c_io_Element(entity_local_name(e));
  ...
  if(!system_p)
  {
    ...
    if (!reference_undefined_p(std_ref))
    {
      ...
      // Add Read Environment for std
      if (!get_bool_property("MEMORY_EFFECTS_ONLY")) {
        //reference std_refe = make_reference(reference_variable(std_ref), NIL);
        // functions that can be pointed by reference_to_effect_func:
        // reference_to_simple_effect
        // reference_to_convex_region
        // reference_to_reference_effect
        //effect effe = (*reference_to_effect_func)(std_refe, make_action_read(make_action_kind_environment()), true);
        effect effe = make_declaration_effect(reference_variable(std_ref), false);
        le = gen_nconc(CONS(EFFECT, effe, NIL), le);
      }
    }
  }
...
/* Transform count "e" into range "[0..e-1]" 
 *
 * No sharing
 */
expression count_expression_to_range_expression(expression e)
{
  ...
  expression re = make_expression(make_syntax_range(r),
				  make_normalized_complex());
  return re;
}

expression count_and_offset_expressions_to_range_expression(expression c, expression o)
{
  expression argm1 = MakeBinaryCall(entity_intrinsic(MINUS_OPERATOR_NAME),
				    copy_expression(c),
				    int_to_expression(1));
  if(!zero_expression_p(o))
    argm1 = MakeBinaryCall(entity_intrinsic(PLUS_OPERATOR_NAME),
			   copy_expression(o),
			   argm1);

  range r = make_range(copy_expression(o), argm1, int_to_expression(1));
  expression re = make_expression(make_syntax_range(r),
				  make_normalized_complex());
  return re;
}

void update_last_reference_subscript(reference r, expression e)
{
  list sl = gen_last(reference_indices(r));
  if(!ENDP(sl)) {
    expression o = EXPRESSION(CAR(sl));
    if(!unbounded_expression_p(o)) {
      expression re = expression_undefined;
      if(!expression_undefined_p(e) && !unbounded_expression_p(e))
	re = count_and_offset_expressions_to_range_expression(e, o);
      else
	re = make_unbounded_expression();

      free_syntax(expression_syntax(o));
      free_normalized(expression_normalized(o));
      expression_syntax(o) = expression_syntax(re);
      expression_normalized(o) = expression_normalized(re);
      expression_syntax(re) = syntax_undefined;
      expression_normalized(re) = normalized_undefined;
      free_expression(re);
    }
  }
  else {
    pips_internal_error("No subscript to update in reference e.\n");
  }
}

/* The range information given in e can either be added as a new
 * subscript or alter the last subscript of any effect in cl or modify
 * the type of a typed anywhere location or have no impact on
 * *anymodule*:*anywhere*.
 *
 * See Ancourt3009/memcpyxx.c. See also CIntrinsics.
 */
void add_range_information_to_cells(list cl, expression e)
{
  FOREACH(CELL, c, cl) {
    ...
    if(!entity_anywhere_locations_p(v)) {
      ...
      // FI: the test should be refined, takig into account the number
      // of dimensions of vt, and the number of existing subscripts
      if(array_type_p(rt)) {
	expression re = count_expression_to_range_expression(e);
	reference_indices(r) = gen_nconc(reference_indices(r),
					 CONS(EXPRESSION, re, NIL));
      }
      if(array_type_p(vt)) {
	int d = (int) array_type_dimension(vt);
	int ns = (int) gen_length(reference_indices(r));
	if(d==ns+1) {
	  expression re = count_expression_to_range_expression(e);
	  reference_indices(r) = gen_nconc(reference_indices(r),
					   CONS(EXPRESSION, re, NIL));
	  ...
	  update_last_reference_subscript(r, e);
	}
	else {
	  type et = array_type_to_element_type(vt);
	  if(pointer_type_p(et)) {
	    if(ns==d+1) {
	      list lsl = gen_last(reference_indices(r));
	      expression s = EXPRESSION(CAR(lsl));
	      if(unbounded_expression_p(s)) {
		// FI: we assume the last subscript is artificial
		expression ns = count_expression_to_range_expression(e);
		EXPRESSION_(CAR(lsl)) = ns;
		free_expression(s);
	      }
	      else {
		pips_internal_error("Unexpected case with d=%d and ns=%d,"
				    " and expression %s.\n",
				    d, ns, expression_to_string(s));
	      }
	    }
	    else {
	      pips_internal_error("Unexpected case with d=%d and ns=%d.\n", d, ns);
	...
	if(pointer_type_p(rt)) {
	  if(cell_typed_anywhere_locations_p(c)) {
	    type pt = type_to_pointed_type(rt);
	    reference r = cell_any_reference(c);
	    entity a = entity_typed_anywhere_locations(pt);
	    reference_variable(r) = a;
	  }
	  else
	    pips_internal_error("Dereferencing must be performed by the caller.");
	}
	// FI: is it possible to end up here?
	// update_last_reference_subscript(r, e);
      }
    }
  }
...
/* It is assumed that the list is linked to a unique reference */
void effects_to_proper_approximation(list el)
{
  FOREACH(EFFECT, e, el) {
    reference r = effect_any_reference(e);
    if(reference_with_unbounded_subscript_p(r)) {
      approximation ap = effect_approximation(e);
      if(!approximation_may_p(ap)) {
...
void add_precondition_information_to_effects(list el)
{
  transformer context;
  ...
  else
  {
    ...
    (*effects_precondition_composition_op)(el, context, false);
  }
}

static list actual_pointer_argument_to_cells(expression e)
{
  list cl = NIL;

#if false
  // FI: this test should be useless and performed by
  // effects_lhs_expression_to_sinks()
  if(expression_address_of_p(e)) {
    call c = expression_call(e);
    expression a = EXPRESSION(CAR(call_arguments(c)));
    cl = effects_lhs_expression_to_sources(a);
    // FI: I should have named the related test cases
    // FI: case &buf[0]
    if(ENDP(cl))
      cl = effects_lhs_expression_to_sinks(e);
  }
  else
    cl = effects_lhs_expression_to_sinks(e);
#endif

  // FI: hard to find the best tradeoff between the accuracy of proper
  // effects and the accuracy due to points-to information
  if(expression_reference_p(e)
     && !(get_pointer_info_kind() == with_points_to)) {
    reference r = copy_reference(expression_reference(e));
    reference_indices(r) =
      gen_nconc(reference_indices(r),
		CONS(EXPRESSION, make_unbounded_expression(), NIL));
    cl = CONS(CELL, make_cell_reference(r), NIL);
  }
  else {
    // Potentially, exploit points-to information but get cumulated
    // effects instead of proper effects
    cl = effects_expression_to_points_to_sinks(e);
  }

  return cl;
}

/* memcpy, memmove, strcmp, strncmp... */
static list memcpy_effects(entity e, list args)
{
  // first read effects for the evaluation of arguments
  list el = generic_proper_effects_of_expressions(args);

  bool write_p = true; // The first argument is written by default

  if(ENTITY_STRCMP_SYSTEM_P(e)
    || ENTITY_STRNCMP_SYSTEM_P(e))
    write_p = false;

  expression e3 = expression_undefined;
  if(!ENDP(CDR(CDR(args))))
    e3 = EXPRESSION(CAR(CDR(CDR(args))));
  //else
  //  e3 = make_unbounded_expression();

  expression e1 = EXPRESSION(CAR(args));
  if (expression_call_p(e1)
      && call_constant_p(expression_call(e1)))
  {
  ...
  // Look for the sinks
  list cl1 = actual_pointer_argument_to_cells(e1);
  // Add range information: specific to memcpy
  add_range_information_to_cells(cl1, e3);
  list el1 = cells_to_read_or_write_effects(cl1, write_p);

  expression e2 = EXPRESSION(CAR(CDR(args)));
  list el2 = list_undefined;
  if (expression_call_p(e2)
      && call_constant_p(expression_call(e2))) {
    el2 = NIL;
  }
  else {
    list cl2 = actual_pointer_argument_to_cells(e2);
    add_range_information_to_cells(cl2, e3);
    el2 = cells_to_read_effects(cl2);
  }

  // effects on buffer for memmove intrinsic
  if (same_string_p(entity_user_name(e), MEMMOVE_FUNCTION_NAME))
  {
    el = gen_nconc(el,memmove_effects(e, args));
  }

  el = gen_nconc(el, gen_nconc(el1, el2));
  return el;
}
 ...
 *
 * memset, strxfrm, strncat,strcat, strncpy, memmove, memcpy
 *
 * Does not exploit points-to information, explicitly or implicitly
 */
static list
...
static list any_rgs_effects(entity __attribute__ ((__unused__)) e, list __attribute__ ((__unused__)) args, bool write_p, bool read_p)
{
  list le = NIL;
  entity private_rgs_entity = entity_undefined;
  reference ref;
  list indices = NIL;
  // To know if random are used in code, so if they have to appear on return statement
  //static bool use_rgs = false;
  ...
  if (write_p) {
    //use_rgs = true;
    le = generic_proper_effects_of_written_reference(ref);
    if (read_p) {
      le = gen_nconc(generic_proper_effects_of_read_reference(ref), le);
    }
  }
  //else if (use_rgs && read_p) {
  //  le = generic_proper_effects_of_read_reference(ref);
  //}
...
static list rgsi_effects(entity e, list args)
{
  list le = generic_proper_effects_of_expressions(args);
  list lr = any_rgs_effects(e, args, true, false);
  le = gen_nconc(le, lr);
  return le;
}
...
{
  list le = generic_proper_effects_of_expressions(args);
  list lr = any_rgs_effects(e, args, true, true);
  le = gen_nconc(le, lr);
  return le;
}

...
/* Returns a list of possible effects */
static list c_intrinsics_pointer_actual_argument_to_effects(expression e, tag act)
{
  // These effects may have already been gathered by the caller
  // list el = generic_proper_effects_of_expression(e);
  list el = NIL;
  list cl = actual_pointer_argument_to_cells(e);
  list el1 = NIL, el2 = NIL;
  switch(act) {
  case 'r': el1 = cells_to_read_effects(cl);
    break;
  case 'w': el1 = cells_to_write_effects(cl);
    break;
  case 'x': el1 = cells_to_read_effects(cl);
    el2 = cells_to_write_effects(cl);
    break;
  default: pips_internal_error("Unexpected tag.\n");
  }
  el = gen_nconc(el, gen_nconc(el1, el2));
  return el;
}

static list c_intrinsics_actual_argument_to_effects(expression e, tag act)
{
  list el = NIL;
  ...
  if(pointer_type_p(t)) {
    if(get_constant_paths_p())
      // Use points-to information if possible
      el = c_intrinsics_pointer_actual_argument_to_effects(e, act);
    else {
      if(act == 'w') {
	list sel = generic_proper_effects_of_complex_address_expression(e, &el, true);
	gen_free_list(sel);
      }
      else if(act == 'r') {
	list sel = generic_proper_effects_of_complex_address_expression(e, &el, false);
	gen_free_list(sel);
      }
      else
	pips_internal_error("Unexpected tag '\%c\'\n", act);

      //#if false
      // FI: this is not generic...
      type pt = type_to_pointed_type(t);
      list nel = NIL;
      FOREACH(EFFECT, ef, el) {
	// Add dereferencing if needed
	reference r = effect_any_reference(ef);
	type rt = points_to_reference_to_concrete_type(r);
	// FI: beware of persistent references used in proper effects
	if(type_equal_p(pt, rt) && pointer_type_p(pt)) {
	  // The actual argument is an array: the last zero, at least,
	  // must be replaced by unbounded and the effect be updated
	  reference nr = copy_reference(r);
	  list sl = reference_indices(nr); // subscript list
	  list lsl = gen_last(sl); // last subscript list
	  if(!ENDP(lsl)) {
	    if(zero_expression_p(EXPRESSION(CAR(lsl)))) {
	      free_expression(EXPRESSION(CAR(lsl)));
	      EXPRESSION_(CAR(lsl)) = make_unbounded_expression();
	      cell nc = make_cell_reference(nr);
	      approximation ap = make_approximation_may();
 	      action ac = (act=='r')?
		make_action_read_memory() : make_action_write_memory();
	      free_cell(effect_cell(ef));
	      effect_cell(ef) = nc;
	      free_action(effect_action(ef));
	      effect_action(ef) = ac;
	      free_approximation(effect_approximation(ef));
	      effect_approximation(ef) = ap;
	    }
	    else
	      pips_internal_error("Unexpected subscript case.\n");
	  }
	  else {
	    // A scalar case, as with &pos, where pos is a scalar

	    // FI: if pt is a struct, all fields must be read or
	...
	else if(type_equal_p(pt, rt)) {
	  // FI: if pt is not a pointer type, nothing to add ?
	  // Effects/hyantes_readtowns ?
	    action ac = (act=='r')?
	      make_action_read_memory() : make_action_write_memory();
	    free_action(effect_action(ef));
	    effect_action(ef) = ac;
	}
	else { // The code must be generic
	  // The actual argument is a pointer. The read effect must be
	  // preserved and an effect on the dereferenced area added
	  // the effect cannot be copied because of a persistent reference 
	  // effect nef = copy_effect(ef);
	  reference nr =  copy_reference(effect_any_reference(ef));
	  // if(effect_region_p(nef)) {
	  entity v = reference_variable(nr);
	  if(!entity_all_locations_p(v)) {
	    if(entity_anywhere_locations_p(v)) {
	      entity nv = entity_typed_anywhere_locations(pt);
	      reference_variable(nr) = nv;
	    }
	    else if(descriptor_convex_p(effect_descriptor(ef))) {
	      int d = (int) gen_length(reference_indices(nr));
	      // FI: cheating with genericity
	      extern entity make_phi_entity(int);
	      entity phi_dp1 = make_phi_entity(d+1);
	      expression phi_e = entity_to_expression(phi_dp1);
	      list sl = CONS(EXPRESSION, phi_e, NIL);
	      reference_indices(nr) = gen_nconc(reference_indices(nr), sl);
	    }
	    else { // effect simple
	      reference_indices(nr) =
		gen_nconc(reference_indices(nr), make_unbounded_subscripts(1));
	    }
	  }

	  // reference nr = copy_reference(effect_any_reference(ef));
	  cell c = make_cell_reference(nr);
	  approximation ap = make_approximation_may();
	  //free_approximation(effect_approximation(nef));
	  //effect_approximation(nef) = ap;
	  action ac = (act=='r')?
	    make_action_read_memory() : make_action_write_memory();
	  //free_action(effect_action(nef));
	  //effect_action(nef) = ac;
	  descriptor d = copy_descriptor(effect_descriptor(ef));
	  // effect nef = (*reference_to_effect_func)(nr, ac, true);
	  effect nef = make_effect(c, ac, ap, d);
	  nel = gen_nconc(nel, CONS(EFFECT, nef, NIL));
	}
      }
      el = gen_nconc(el, nel);
      //#endif
    ...
    el = c_actual_argument_to_may_summary_effects(e, act);
  ...
  FOREACH(EFFECT, ef, el) {
    ...
    if(entity_all_locations_p(v)) {
      ...
      if(!ENDP(sl))
	pips_internal_error("Bad use of anywhere.\n");
    }
  }
...
/**
 ...
 @param act is an action tag as described in the  IoElementDescriptorTable.
	...
	n: no further effects

	r, w, x: potentially, pointers

	R, W: formatted IOs

	s: stream or integer file descriptor
...
static list effects_of_C_ioelem(expression arg, tag act)
{
  ...
  case 's':
    ...
    type arg_t = points_to_expression_to_concrete_type(arg);
    // FI: assuming no recursive descent is needed to get all fields,
    // i.e. no field is itself a struct
    type arg_pt = type_to_pointed_type(arg_t);
    list fl = struct_type_to_fields(arg_pt);
	...
	l_fp_eff = gen_nconc(l_fp_eff, CONS(EFFECT, fp_eff_w, CONS(EFFECT, fp_eff_r, NIL)));
	  ...
	  if(false) {
	    // FI: generate an effect on the whole data structure, e.g. fd[0]
	    effect_add_dereferencing_dimension(fp_eff_r);
	    effect_to_may_effect(fp_eff_r);
	    ...
	    // FI: generate an implicit effect on all data structure
	    // fields, e.g. fd[0][*]. This leads to a typing error
	    // because all fields do not have the same type.
	    effect_add_dereferencing_dimension(fp_eff_r);
	    expression u = make_unbounded_expression();
	    // The function is defined in effects-simple and not in effects-util
	    void simple_effect_add_expression_dimension(effect eff, expression exp);
	    simple_effect_add_expression_dimension(fp_eff_r, u);
	    effect_to_may_effect(fp_eff_r);
	    fp_eff_w = copy_effect(fp_eff_r);
	    effect_action(fp_eff_w) = make_action_write_memory();
	    l_fp_eff = gen_nconc(l_fp_eff, CONS(EFFECT, fp_eff_w, CONS(EFFECT, fp_eff_r, NIL)));
	    ...
	    // FI: if we are dealing with a pointer to a struct, we
	    // have to generate one or two effect(s) for each field,
	    // e.g. fd[0][a], fd[0][b], fd[0][c]...
	    FOREACH(ENTITY, f, fl) {
	      effect n_fp_eff_r =  copy_effect(fp_eff_r);
	      effect_add_dereferencing_dimension(n_fp_eff_r);
	      effect_add_field_dimension(n_fp_eff_r, f);
	      effect_to_may_effect(n_fp_eff_r);
	      fp_eff_w = copy_effect(n_fp_eff_r);
	      effect_action(fp_eff_w) = make_action_write_memory();
	      l_fp_eff = gen_nconc(l_fp_eff, CONS(EFFECT, fp_eff_w, CONS(EFFECT, n_fp_eff_r, NIL)));
	    }
	    // free_effect(fp_eff_r); used below in a test
	  }
        }
      }
  ...
  case 'x':
    ...
    le = gen_nconc(le, c_intrinsics_actual_argument_to_effects(arg, act));
    break;
  case 'R':
  case 'W':
                ...
                (char_type_p(t) && (gen_length(variable_dimensions(v)) == 1)))))
    {
      ...
      le = gen_nconc(le, c_intrinsics_actual_argument_to_effects(arg, tolower(act)));
    }
    break;
  case 'n':
...
effects_of_implied_do(expression exp, tag act)
{
  ...
  FOREACH(EXPRESSION, expr, CDR(CDR(args))) {
    ...
    lr = NIL;
    FOREACH(EFFECT, eff, lep) {
      if (effect_entity(eff) != index)
	lr =  CONS(EFFECT, eff, lr);
      else if(act==is_action_write /* This is a read (FI: I do not understand this comment) */
  ...
  le = (*effects_union_over_range_op)(le,
      index,
...
static
list not_implemented_intrinsics_effects(entity e, list args __attribute__ ((unused)))
{
  pips_internal_error("Effects for intrinsic \"%s\" are not implemented.\n",
		      entity_user_name(e));
  return NIL;
}
...
list time_effects(entity e __attribute__ ((unused)), list args)
{
  ...
  if(get_bool_property("TIME_EFFECTS_USED")) {
    ...
    effect re = make_anywhere_effect(make_action_read_memory());
    effect we = make_anywhere_effect(make_action_write_memory());
...
/* Add a time conversion buffer effect, that is a read and a write on a particular hidden buffer (man localtime) */
static
list time_buffer_effects(entity e __attribute__ ((unused)), list args)
{
  list le = generic_proper_effects_of_expressions(args);

  entity private_time_entity = FindEntity(TIME_EFFECTS_PACKAGE_NAME, TIME_EFFECTS_BUFFER_NAME);
...
/**
 * Add some Read for the IO on return/exit/abort statement in main function
 */
static list generic_end_effects(entity __attribute__ ((__unused__)) e, list args, bool __attribute__ ((__unused__)) return_p) {
  list le = NIL;    //return list effects
  list lse = NIL;   //side effects of args
  list lio = NIL;   //IO effects
  //list lr = NIL;    //random effects
  pips_debug(5, "begin\n");

  //compute side effects
  lse = generic_proper_effects_of_expressions(args);

  // NL: add of IO Read are now done by cumulated effects, and it's no more a proper effect
//  if (entity_main_module_p(get_current_module_entity())) {
//    //compute IO effects
//    //see generic_c_io_effects()
//    expression unit = make_unbounded_expression();
//    lio = generic_logical_units_effects(unit, true);
//    // Do we also have to add stdin/stdout/stderr?
//    // LUNS[*] should normally be enough
//
//    //compute random effects
//    //lr = any_rgs_effects(e, args, false, true);
//  }
 ...
 * difference between return and exit/abort are subtle and ambiguous for C
 * see https://stackoverflow.com/questions/461449/return-statement-vs-exit-in-main
 * or the norm?
 * For the moment end_program_effects and end_process_effects done the same thing
 */
static list end_program_effects(entity e, list args) {
  return generic_end_effects(e, args, true);
}

/**
 * for exit/abort statement
 * difference between return and exit/abort are subtle and ambiguous for C
 * see https://stackoverflow.com/questions/461449/return-statement-vs-exit-in-main
 * or the norm?
 * For the moment end_program_effects and end_process_effects done the same thing
 */
static list end_process_effects(entity e, list args) {
  return generic_end_effects(e, args, false);
}

/**
 * MPI functions Effects
 * TODO MPI Effects
 */

/**
 * For the moment it is a copy of safe_c_effects
 * But it's not good at all.
 * For instance, in case of an array it's depend of the count variable (2nd parameter of MPI_Send/Recv) to know how many array cell is read/write
 * also have to look the datatype (3nd parameter), if it's a custom hard to predict something
 *
 * This function is not enough conservative, for array, in the worst case, it must say all the array in read/write
 * How to do it?
 */
static list
mpi_functions_effects(entity e __attribute__ ((__unused__)), list args)
{
  list lw = NIL, lr = NIL;
...
static list
mpi_send_effects(entity e __attribute__ ((__unused__)), list args)
{
  list la = NIL, lr = NIL;
  //la list of effects on array/variable

  pips_debug(5, "begin\n");
//  print_expressions(args);
  lr = generic_proper_effects_of_expressions(args);

//  pips_debug(5, "lr effects\n");
//  print_memory_effects(lr);
//  FOREACH(EXPRESSION, arg, args)
//    {
//      lw = gen_nconc(lw, c_actual_argument_to_may_summary_effects(arg, 'x'));
//    }
//unused//  expression earray = EXPRESSION(CAR(args));// (expression) args->car.p;
//unused//   expression enbelem = EXPRESSION(CAR(CDR(args)));
//unused//   expression edatatype = EXPRESSION(CAR(CDR(CDR(args))));
  /*
  possible value of edatatype :
  OpenMPI : ompi_mpi_double, ompi_mpi_int, ...
  MPIch : (MPI_Datatype)0x4c00xxx
  */
// TODO
//  pips_debug(5, "lw effects\n");
//  print_memory_effects(lw);
  pips_debug(5, "end\n");
  lr = gen_nconc(lr, la);
  return(lr);
}
