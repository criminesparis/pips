/*
  ...
  $Id: mappings.c 23375 2017-05-11 08:58:06Z ancourt $
...
GENERIC_GLOBAL_FUNCTION(live_out_regions, statement_effects)
...
list
load_live_out_regions_list(statement s)
{
  return(effects_effects(load_live_out_regions(s)));
}

void
store_live_out_regions_list(statement s, list l)
{
  store_live_out_regions(s, make_effects(l));
}

void
update_live_out_regions_list(statement s, list l)
{
  update_live_out_regions(s, make_effects(l));
}
