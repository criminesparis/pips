/*
  ...
  $Id: interface.c 23495 2018-10-24 09:19:47Z coelho $
...
bool summary_effects(const string module_name)
{
    ...
    // This is dealt with by set_current_phase_context()
 ...
 */
list
proper_constant_path_effects_of_any_expression(expression e, bool lhs_p)
{
    list le;
    bool context_stack_defined_p =
	effects_private_current_context_stack_initialized_p();
...
/* For a right hand side expression */
list proper_constant_path_effects_of_expression(expression e)
{
  return proper_constant_path_effects_of_any_expression(e, false);
}

/* For a left hand side expression */
list proper_constant_path_effects_of_lhs_expression(expression e)
{
  return proper_constant_path_effects_of_any_expression(e, true);
}
 ...
 * generic_effects_reset_all_methods()
 */
list expression_to_proper_constant_path_effects(expression e)
{
    list le;
...
list lhs_expression_to_proper_constant_path_effects(expression e)
{
    list le;

    debug_on("EFFECTS_DEBUG_LEVEL");

    le = proper_constant_path_effects_of_lhs_expression(e);
...
bool update_loops_locals(const char* module_name, statement module_stat)
{
  ...
  gen_context_recurse(module_stat, &changed,
                      loop_domain, gen_true2, update_loop_locals);
