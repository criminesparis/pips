/*
  ...
  $Id: basic.c 23412 2017-08-09 15:07:09Z irigoin $
...
/* Get rid of all old values and arguments. Argument pre is unchanged
   and result as is allocated. Should be a call to
   transformer_range().  Should not be in basic.c.
 */
transformer
...
/* Is value v used with a non-zero coefficient by the equations of
 *  transformer t?
 */
...
/* Is value v used with a non-zero coefficient by the inequalities of
 *  transformer t?
 */
