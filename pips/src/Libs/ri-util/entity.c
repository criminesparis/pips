/*
  ...
  $Id: entity.c 23495 2018-10-24 09:19:47Z coelho $
...
/* Find an entity, if it exists, from its global name, a.k.a. its
 * entity name.
 *
...
/* Formal parameters do not use the standard ram storage. However, a
   formal area is used for points-to stubs */
