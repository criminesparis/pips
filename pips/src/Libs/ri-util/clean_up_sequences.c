/*
  $Id: clean_up_sequences.c 23495 2018-10-24 09:19:47Z coelho $
...
void
initialize_clean_up_sequences_statistics(void)
{
...
void
display_clean_up_sequences_statistics(void)
{
...
typedef struct {
  ...
  bool changed;  // whether anything was changed
} cusq_context;
...
bool
statement_to_goto_table_flt(instruction i)
{
...
void
discard_statement_to_goto_table(void)
{
  HASH_MAP(k, v, {
...
static void
deal_with_pending_comment(statement s, string * the_comments)
{
