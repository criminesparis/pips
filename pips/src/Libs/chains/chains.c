/*
 ...
 $Id: chains.c 23495 2018-10-24 09:19:47Z coelho $
 ...
 *
 */
static void genref_any_loop(
  statement body,
  statement st,
  list locals,
  _UNUSED_ bool one_trip_do_p)
{
  set gen = GEN( st );
  set ref = REF( st );
 ...
 * @param never_executed_p tell if loop never executed (when it's possible, do loop only) (unused)
 */
