...
%type <status> i_checkpoint i_show i_unknown i_checkactive i_touch i_version
%type <status> i_timeout
...
i_timeout: TK_TIMEOUT TK_INT TK_ENDOFLINE
	{
    printf("# unsupported 'timeout %d'" JUMPL, $2);
	}
	;
