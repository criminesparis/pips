/*
  ...
  $Id: arithmetique-local.h 1673 2023-07-10 12:21:00Z coelho $
...
#if defined(LINEAR_VALUE_IS_INT128)
// TODO
#error "not implemented yet"

#include <inttypes.h>
#define LINEAR_VALUE_STRING "int128"
typedef __int128 Value;
#define VALUE_FMT "???"
#define VALUE_CONST(val) (val##LLL)
#define VALUE_NAN ???_MIN
/* CAUTION! the min is defined as hard-min+1 so as to preserve the
 * symetry (-min==max) and to have a nan value. FC.
 */
#define VALUE_MIN (???_MIN+1LL)
#define VALUE_MAX ???_MAX
#if defined(LINEAR_VALUE_ASSUME_SOFTWARE_IDIV) && \
  defined(__SIZEOF_???__) &&                \
  __SIZEOF_???__ != 8
  #error "long long is expected to be 64-bit to use software idiv"
#endif
#define VALUE_SQRT_MIN ???LLL /* floor(sqrt(LONG_LONG_MAX)) */
#define VALUE_SQRT_MAX -???LLL
#define VALUE_ZERO (0LLL)
#define VALUE_ONE  (1LLL)
#define VALUE_MONE (-1LLL)
...
// for some yacc-generated code
#ifndef _has_yy_size_t
#define _has_yy_size_t
typedef size_t yy_size_t;
#endif /* _has_yy_size_t */
