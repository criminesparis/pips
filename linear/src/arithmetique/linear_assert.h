/*
  ...
  $Id: linear_assert.h 1669 2019-06-26 17:24:57Z coelho $
...
#ifndef __linear_assert_included__
#define __linear_assert_included__
...
#else
extern int linear_assertion_result;
#define assert(ex) 													\
  linear_assertion_result = ((ex)? 1: (fprintf(stderr, _linear_assert_message), abort(), 0))
#define linear_assert(msg, ex) {								\
    if (!(ex)) {                                                \
...
#endif // NDEBUG
#endif // __linear_assert_included__
